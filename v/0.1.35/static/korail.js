...
function _buildModePanel(panel, cfg) {
  ...
  const etcToggle = el('button', 'toggle-chip on'); etcToggle.type = 'button';
  etcToggle.textContent = 'ON';
  ...
  function renderEtc() {
    ...
    etcToggle.textContent = candFallback ? 'ON' : 'OFF';
